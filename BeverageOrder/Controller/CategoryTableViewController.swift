...
//        }
        ...
        cell.textLabel?.text = categoryList.category
        cell.imageView?.image = UIImage(named: categoryPic[indexPath.row])
        cell.imageView?.backgroundColor = UIColor(named: "LightBlueKEBUKE")
        // Configure the cell...
        return cell
    }
